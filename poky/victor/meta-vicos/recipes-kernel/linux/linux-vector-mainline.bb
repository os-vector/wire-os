...
KERNEL_DEVICETREE = "qcom/qcom-apq8009-anki-vector.dts"
KERNEL_CONFIG = "apq8009_defconfig"

# Override SRC_URI in a copy of this recipe to point at a different source
# tree if you do not want to build from Linus' tree.
#SRC_URI = "git://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git;protocol=git;nocheckout=1;name=machine"

SRC_DIR   =  "${WORKSPACE}/kernel/linux-vector-mainline"
S         =  "${UNPACKDIR}/kernel/linux-vector-mainline"

LINUX_VERSION ?= "6.19.0"
LINUX_VERSION_EXTENSION:append = "-vector"
