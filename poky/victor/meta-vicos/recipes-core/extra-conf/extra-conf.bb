...
do_install () {
	...
	ln -sf /usr/lib/systemd/system/usb-net.service ${D}/usr/lib/systemd/system/multi-user.target.wants/
	...
	install -m 0644 ${S}/modprobe/blacklist.conf ${D}/etc/modprobe.d/blacklist.conf
}
