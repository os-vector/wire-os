...
{
	switch (function) {
	case MSM_CAMERA_SUBDEV_CSIPHY:		return 0;
	case MSM_CAMERA_SUBDEV_CSID:		return 1;
	case MSM_CAMERA_SUBDEV_ISPIF:		return 2;
	case MSM_CAMERA_SUBDEV_VFE:		return 3;
	case MSM_CAMERA_SUBDEV_AXI:		return 4;
	case MSM_CAMERA_SUBDEV_VPE:		return 5;
	case MSM_CAMERA_SUBDEV_SENSOR:		return 6;
	case MSM_CAMERA_SUBDEV_ACTUATOR:	return 7;
	case MSM_CAMERA_SUBDEV_EEPROM:		return 8;
	case MSM_CAMERA_SUBDEV_CPP:		return 9;
	case MSM_CAMERA_SUBDEV_CCI:		return 10;
	case MSM_CAMERA_SUBDEV_LED_FLASH:	return 11;
	case MSM_CAMERA_SUBDEV_STROBE_FLASH:	return 12;
	case MSM_CAMERA_SUBDEV_BUF_MNGR:	return 13;
	case MSM_CAMERA_SUBDEV_SENSOR_INIT:	return 14;
	case MSM_CAMERA_SUBDEV_OIS:		return 15;
	case MSM_CAMERA_SUBDEV_FLASH:		return 16;
	case MSM_CAMERA_SUBDEV_IR_LED:		return 17;
	case MSM_CAMERA_SUBDEV_IR_CUT:		return 18;
	case MSM_CAMERA_SUBDEV_EXT:		return 19;
	default:				return -1;
	}
}
...
int msm_sd_register(struct msm_sd_subdev *msm_subdev)
{
	...
	if (gid >= 0) {
		...
		msm_subdev->sd.entity.function = MEDIA_ENT_F_V4L2_SUBDEV_UNKNOWN;
	}
